    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="{{ route('Dashboard') }}"><img src="{{ asset('assets/images/logo.png') }}" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="{{ route('Dashboard') }}"><img src="{{ asset('assets/images/logo-mini.png') }}" alt="logo" /></a>
            </div>
                    ...
                    <li class="nav-item nav-profile">
                        <a href="{{ route('AdminProfile') }}" class="nav-link">
                            <div class="nav-profile-image">
                                @if (auth('admin')->user()->avatar != null)
                                <img class="profile_img_icon" src="{{ asset(auth('admin')->user()->avatar) }}" alt="profile">
                                @else
                                <img class="profile_img_icon" src="{{ asset('assets/images/faces/admin.png') }}" alt="profile">
                                @endif
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center">
                        <span class="text-muted text-center d-block d-sm-inline-block">Copyright © 2022 <a href="#" target="_blank">Your Doctor</a>. All rights reserved.</span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
